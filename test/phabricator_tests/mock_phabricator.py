...
def get_comments_return_value():
    """
    Function to mock the correct return value for test 'test_get_comments_successful'
    """
    return [
        {
            'action': 'comment',
...
def generate_phids_response():
    ...
    list_of_phids = [
        'PHID-USER-xxxxxxxxxxxxxxxxxxx1',
        'PHID-USER-xxxxxxxxxxxxxxxxxxx2'
    ]
    return list_of_phids, raw_response


def author_data_rawResponse():
    """
